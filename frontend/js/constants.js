const contractAddress = "0xDC469464bf1ECE085769A3283907103e559e4dF8"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the DopeSkulls Nft Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The DopeSkulls Nft Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
